# -*- coding: utf-8 -*-
"""TOTAL PREDICTION.ipynb with Bi-LSTM model"""
...
def create_sequence(dataset):
    return np.asarray([dataset[index:index + 1] for index in range(len(dataset))])
...
plt.title("Flux vs Time Prediction for GRB GRB060206 (BiLSTM Model)")
plt.show()
...
np.save("X_new_bilstm.npy", X_new)
np.save("Y_new_bilstm.npy", Y_new)
